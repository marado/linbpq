...
char * FwdDetailtxt()
{
	char Msg[] =
		...
		"<input onclick=save(this.form) value=Update type=button>\r\n"
		"<input onclick=startf(this.form) value=\"Start Forwarding\" type=button>\r\n"
		"</form>\r\n";
...
char * MainConfigtxt()
{
	char Msg[] =
		...
		"\r\n"
		"<div id=\"main\" style=\"border: 2px solid ; overflow: auto; position: relative; top: 10px; height: 930px; width: 740px; left: 86px;\">\r\n"
		...
		"\r\n"
		"<div style=\"position: absolute; left: 290px; top: 900px;\"><input name=\"Save\" value=\"Save\" type=\"submit\"> <input name=\"Cancel\" value=\"Cancel\" type=\"submit\"></div>\r\n"
		"</form>\r\n"
		"</div>\r\n";
...
char * UserDetailtxt()
{
	char Msg[] =
		...
		"       <input style=\"width: 20px;\" name=APRSSSID value=%s></td>"
		"     </tr>\r\n"
		"\r\n"
		"	  </tbody>"
		"  </table>"
